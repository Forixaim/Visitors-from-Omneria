...
public class DragonShotProjectile extends SimpleEnergyProjectile
{
    protected int lifetime = 80;


    public DragonShotProjectile(EntityType<? extends Projectile> pEntityType, Level pLevel)
    {
    ...
    protected void onHitEntity(@NotNull EntityHitResult hitResult) {
        ...
        if (!this.level().isClientSide()) {
            ...
            if (entity1 instanceof LivingEntity livingEntity && playerpatch != null)
            {
                ...
                EpicFightDamageSource damage = playerpatch.getDamageSource(GenesisWyrmAnimations.BLAST_AUTO1, InteractionHand.MAIN_HAND);
