...
public interface DialogueNPC {
     ...
     */
    void handleNpcInteraction(Player player, long interactionID);
    ...
    default void chat(Component component){
        if(getConversingPlayer() != null) {
            getConversingPlayer().displayClientMessage(ComponentBuilder.BUILDER.buildDialogue((Entity) this, component),false);
        }
    }
