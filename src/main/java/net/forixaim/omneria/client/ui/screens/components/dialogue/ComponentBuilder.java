...
public class ComponentBuilder
{
    ...
    public static final ComponentBuilder BUILDER = new ComponentBuilder();
    private final EntityType<?> entityType;

    public ComponentBuilder(Entity entity)
    {
        this.entityType = entity.getType();
    }

    public ComponentBuilder(EntityType<?> entityType)
    {
    ...
    {
        Component component = Component.translatable(entityType + ".dialogue" + i);
    ...
    {
        Component component = Component.translatable(entityType + ".dialogue" + i, objects);
    ...
    {
        Component component = Component.translatable(entityType + ".dialogue" + skinID + "_" + i);
    ...
    {
        Component component = Component.translatable(entityType + ".dialogue" + i, s);
        return Component.literal("\n").append(component);
    }
