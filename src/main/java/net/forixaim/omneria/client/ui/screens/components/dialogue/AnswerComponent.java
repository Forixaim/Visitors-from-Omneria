...
public class AnswerComponent
{
    ...
    public AnswerComponent(Component message) {
...
//        index = name.getString().length();//名字就不用打字机了
     ...
     * @return 字是否全显示完了
     */
    public void updateTypewriterDialogue(SoundEvent typewriterSound) {
        Style style = message.getStyle();
